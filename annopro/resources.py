...
RESOURCE_DICT = {
    ...
    "cafa4_del.csv": {
        "url": "http://localhost:8000/annopro/data/cafa4_del.csv",
        "md5sum": "d00b71439084cb19b7d3d0d4fbbaa819"
    },
    "cafa4.dmnd": {
        "url": "http://localhost:8000/annopro/data/cafa4.dmnd",
        "md5sum": "a2a6cba9af26dbe1911e14a306db2712"
    },
    "data_grid.pkl": {
        "url": "http://localhost:8000/annopro/data/data_grid.pkl",
        "md5sum": "fb2d2d86a4bc21c6e60fac996b3a90d3"
    },
    "go.pkl": {
        "url": "http://localhost:8000/annopro/data/go.pkl",
        "md5sum": "8d7a975d38a4af670b0370f4ea722a2a"
    },
    "go.txt": {
        "url": "http://localhost:8000/annopro/data/go.txt",
        "md5sum": "1dae308468fa00ae6d5796fd22c65044"
    },
    "row_asses.pkl": {
        "url": "http://localhost:8000/annopro/data/row_asses.pkl",
        "md5sum": "bf9bb1eda744a60c381d19b275ac6f33"
    },
    "terms_biological_process.pkl": {
        "url": "http://localhost:8000/annopro/data/terms_biological_process.pkl",
        "md5sum": "e79cf5e006432c19606b8a482cf7ddfa"
    },
    "terms_cellular_component.pkl": {
        "url": "http://localhost:8000/annopro/data/terms_cellular_component.pkl",
        "md5sum": "8cf58075eba65e2bb710566e4ef93f42"
    },
    "terms_molecular_function.pkl": {
        "url": "http://localhost:8000/annopro/data/terms_molecular_function.pkl",
